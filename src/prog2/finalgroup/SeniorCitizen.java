...
public class SeniorCitizen extends JPanel {
    ...
    public SeniorCitizen(){
        ...
        try {
            seniors = programUtility.seniorCitizenPopulation();
        } catch (Exception e)
        {
            e.printStackTrace();
        }

        int row = programUtility.listCounter(seniors);
        ...
        label.setText("Senior Citizen Population: " + row);
